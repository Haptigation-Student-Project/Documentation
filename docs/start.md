---
title: Start
description: Intro to the documentation pages
sidebar_position: 1
---

# Welcome Welcome, this is the Haptigation Documentation
...
Haptigation is an indepandant student project relying on private sponsorships. 
